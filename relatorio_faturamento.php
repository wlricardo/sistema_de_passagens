...
if (!isset($_SESSION['logado']) || $_SESSION['perfil_id'] != 1) { header('Location: index.php'); exit(); }
...
<head>
    ...
    <style>
        body { font-family: monospace; margin: 30px; background: #fff; }
        table { width: 100%; border-collapse: collapse; margin-top: 15px; margin-bottom: 30px; }
        table th, table td { border: 1px solid #000; padding: 8px; text-align: left; }
        table th { background: #f2f2f2; }
        .btn { padding: 5px 10px; background: #ddd; text-decoration: none; color: #000; border: 1px solid #000; }
...
<body>
    ...
    <table>
        <thead>
            <tr><th>Ano / Mês</th><th>Bilhetes Emitidos</th><th>Faturamento Bruto</th></tr>
        </thead>
        <tbody>
    ...
    <table>
        <thead>
            <tr><th>Forma de Pagamento</th><th>Quantidade de Vendas</th><th>Total Arrecadado</th></tr>
        </thead>
        <tbody>
